...
shaka.hls.HlsParser = class {
  ...
  createSegmentReference_(
      initSegmentReference, previousReference,
      lastDiscontinuityStartReferenceStartTime, hlsSegment, startTime,
  ...
  createSegments_(playlist, stream, mediaSequenceToStartTime, variables,
    ...
    for (let i = 0; i < hlsSegments.length; i++) {
      ...
      const lastDiscontinuityStartReferenceStartTime = foundDiscontinuityStart ?
          startTime : lastDiscontinuityStartReference ?
          lastDiscontinuityStartReference.startTime : 0;
