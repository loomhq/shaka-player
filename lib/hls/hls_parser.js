...
shaka.hls.HlsParser = class {
  ...
  createSegmentReference_(
      initSegmentReference, previousReference, lastDiscontinuityStartReferenceStartTime, hlsSegment, startTime,
    ...
    const timestampOffset = lastDiscontinuityStartReferenceStartTime ?
      lastDiscontinuityStartReferenceStartTime : 0;
    ...
    return new shaka.media.SegmentReference(
        ...
        endByte,
        initSegmentReference,
        /* timestampOffset= */ timestampOffset, // This value is ignored in sequence mode.
        /* appendWindowStart= */ 0,
        /* appendWindowEnd= */ Infinity,
        partialSegmentRefs,
        tilesLayout,
  ...
  createSegments_(verbatimMediaPlaylistUri, playlist, type, mimeType,
    ...
    let lastDiscontinuityStartReference = null;
    let foundDiscontinuityStart = false;
    ...
    for (let i = 0; i < hlsSegments.length; i++) {
      ...
      if (discontinuityTag) {
        ...
        foundDiscontinuityStart = true;
        lastDiscontinuityStartReference = null;
      }
      ...
      const lastDiscontinuityStartReferenceStartTime = foundDiscontinuityStart ? startTime : lastDiscontinuityStartReference ? lastDiscontinuityStartReference.startTime : 0;

      const reference = this.createSegmentReference_(
          initSegmentRef,
          previousReference,
          lastDiscontinuityStartReferenceStartTime,
          item,
          startTime,
          variables,
      ...
      if (foundDiscontinuityStart) {
        foundDiscontinuityStart = false;
        lastDiscontinuityStartReference = reference;
      }
    }
