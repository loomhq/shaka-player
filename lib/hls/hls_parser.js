...
shaka.hls.HlsParser = class {
  ...
  createSegmentReference_(
      initSegmentReference, previousReference, lastDiscontinuityStartReference, hlsSegment, startTime,
    ...
    const timestampOffset = lastDiscontinuityStartReference ?
  ...
  createSegments_(verbatimMediaPlaylistUri, playlist, type, mimeType,
    ...
    for (let i = 0; i < hlsSegments.length; i++) {
      ...
      const reference = this.createSegmentReference_(
          initSegmentRef,
          previousReference,
          lastDiscontinuityStartReference,
          item,
          startTime,
          variables,
